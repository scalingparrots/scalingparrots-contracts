...
contract Controller is AccessControl {
    ...
    /// @param _splitter Splitter contract address
    /// @param _split Splitter amount
    ...
    /// @notice Change the splitter contract, which is used in conversion of non-core strategy rewards
